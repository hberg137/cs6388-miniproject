"""
This script is called by the plugin-wrapper, FlipTiles.js, which passes down the
...
from FlipTiles import FlipTiles
...
plugin = FlipTiles(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
