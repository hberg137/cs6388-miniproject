"""
This script is called by the plugin-wrapper, AutoPlace.js, which passes down the
...
plugin = AutoPlace(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
